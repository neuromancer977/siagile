...
public class IsBornTest {
	...
	public void testEmployeeIsBornToday() {
		assertThat(employee("Doe, John, 1982/10/08, jonh.doe@foobar.com"), is(born("2008/10/08")));
		assertThat(employee("Doe, John, 0000/00/00, jonh.doe@foobar.com"), is(not(born("2008/10/08"))));
	}
}
